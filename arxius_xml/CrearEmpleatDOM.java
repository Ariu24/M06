package arxius_xml;
//importar classes i interficies del dom
import org.w3c.dom.*;
//
    ...
    public static void main (String args[]) throws IOException {
        ...
        try {
            ...
            for ( ; ;){
                ...
                if (id>0) {
                    //creem l'etiqueta empleat <empleat> </empleat>
                    ...
                    //dintre de empleat hi haura informacio que ompli empleat
        ...
        public static void CrearElement (String dadaEmpleat, String valor, Element arrel, Document document) {
            ...
            //partint d'un element s'afegeix un fill
            //primer crea la etiqueta
            arrel.appendChild (elem);
            //despres l'interior de l'etiqueta
